...
WebUI.callTestCase(findTestCase('THANOS/LOGIN/Login Client'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
if (order == 'job') {
    ...
    WebUI.click(findTestObject('THANOS/Halaman Deskripsi post Job/02-Type Job Private'))

    WebUI.setText(findTestObject('THANOS/Halaman Detail Budget post Job/input search freelancer'), freelancer)

    WebUI.click(findTestObject('THANOS/Halaman Detail Budget post Job/button search cari freelancer'))

    WebUI.click(findTestObject('THANOS/Halaman Detail Budget post Job/button pilih freelancer'))

    WebUI.click(findTestObject('THANOS/Halaman Detail Budget post Job/button submit freelancer'))
    ...
    WebUI.setText(findTestObject('THANOS/Halaman Detail Budget post Job/04-Input Judul'), juduljob)
