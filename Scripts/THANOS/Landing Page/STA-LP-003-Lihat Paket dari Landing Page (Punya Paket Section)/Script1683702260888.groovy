...
WebUI.click(findTestObject('THANOS/Landing Page/Desain Logo/Button Cek Harga Paket'))

WebUI.verifyElementVisible(findTestObject('THANOS/Landing Page/Desain Logo/H3 Harga Paket'))
