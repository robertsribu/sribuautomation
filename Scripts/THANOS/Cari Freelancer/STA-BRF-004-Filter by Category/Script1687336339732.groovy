...
System.print(textkategori)

kategoriselected = WebUI.getText(findTestObject('THANOS/Cari Freelancer/Kategori Filter selected'))

WebUI.verifyMatch(textkategori, kategoriselected, false)
