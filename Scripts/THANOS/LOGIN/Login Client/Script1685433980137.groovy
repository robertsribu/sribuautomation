...
WebUI.setText(findTestObject('THANOS/Halaman Login/username'), GlobalVariable.userclient)

WebUI.setText(findTestObject('THANOS/Halaman Login/password'), GlobalVariable.passclient)
