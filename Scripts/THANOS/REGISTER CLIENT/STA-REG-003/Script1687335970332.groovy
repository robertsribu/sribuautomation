...
WebUI.click(findTestObject('THANOS/Halaman Thankyou Page/Button Lihat Paket'))

//Masuk ke Halaman Paket List
WebUI.waitForElementPresent(findTestObject('THANOS/Halaman Package Kontes List/Title Halaman Paket Kontes List'), 20, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('THANOS/Halaman Package Kontes List/Title Halaman Paket Kontes List'), 1)
