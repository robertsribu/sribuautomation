...
// Masuk dari halaman Paket Job Detail
...
WebUI.click(findTestObject('THANOS/Halaman Register Client/Kebijakan privasi pop Up'))

WebUI.verifyElementPresent(findTestObject('THANOS/Halaman Kebijakan Privasi/Title Halaman Kebijakan privasi'), 1, FailureHandling.STOP_ON_FAILURE)
...
// Masuk dari halaman Paket Kontes Detail
WebUI.navigateToUrl('http://128.199.177.111:8002/id/launch/logo-design/packages')

WebUI.scrollToPosition(0, 200)

WebUI.click(findTestObject('THANOS/Halaman Package Kontes Detail/Button Pilih Paket Kontes', [('id') : buttonpilihpaketkontes]))
