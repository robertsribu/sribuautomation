...
WebUI.click(findTestObject('THANOS/Halaman Register Client/Kebijakan privasi'))

WebUI.verifyElementPresent(findTestObject('THANOS/Halaman Kebijakan Privasi/Title Halaman Kebijakan privasi'), 1)
