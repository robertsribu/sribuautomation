...
WebUI.click(findTestObject('THANOS/Halaman Register Client/Syarat dan ketentuan Pop Up'))

WebUI.verifyElementPresent(findTestObject('THANOS/Halaman Syarat dan Ketentuan/Title Halaman Syarat dan Ketentuan'), 1, 
