...
WebUI.click(findTestObject('THANOS/Halaman Register Client/Peraturan Klien Pop Up'))

WebUI.verifyElementPresent(findTestObject('THANOS/Halaman Peraturan Klien/Title Halaman Peraturan klien'), 1, FailureHandling.STOP_ON_FAILURE)
